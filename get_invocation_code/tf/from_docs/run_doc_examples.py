...
if __name__ == '__main__':
    misc_addr = '/media/nimashiri/DATA/vsprojects/FSE23_2/get_invocation_code/tf/from_docs/hist.txt'
    ...
    data = pd.read_csv('/media/nimashiri/DATA/vsprojects/FSE23_2/data/tf/tf_apis/api_with_doc_example.csv')
    ...
    for id_, row in data.iterrows():
        ...
        if api_splt[0] not in hist:
            ...
            write_to_disc(d, f'/media/nimashiri/SSD1/tensorflow_API_examples/{api_splt[0]}{id_}.py')
