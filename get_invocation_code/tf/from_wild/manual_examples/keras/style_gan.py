...
#     os.makedirs("/media/nimashiri/SSD1/FSE23_2/get_invocation_code/tf/from_wild/manual_examples/data/celeba_gan")

# url = "https://drive.google.com/uc?id=1O7m1010EJjLE5QxLZiM9Fpjs7Oj6e684"
# output = "/media/nimashiri/SSD1/FSE23_2/get_invocation_code/tf/from_wild/manual_examples/data//data.zip"
# gdown.download(url, output, quiet=True)

# with ZipFile("/media/nimashiri/SSD1/FSE23_2/get_invocation_code/tf/from_wild/manual_examples/data/celeba_gan/data.zip", "r") as zipobj:
#     zipobj.extractall("celeba_gan")

# Create a dataset from our folder, and rescale the images to the [0-1] range:

ds_train = keras.preprocessing.image_dataset_from_directory(
    "/media/nimashiri/SSD1/FSE23_2/get_invocation_code/tf/from_wild/manual_examples/data/img_align_celeba", label_mode=None, image_size=(64, 64), batch_size=32
)
